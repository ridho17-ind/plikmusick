...
async def play(_, message: Message):
    ...
    if audio:
        ...
        return await message.reply_photo(
            photo=thumb,
            caption=f"❤️‍🔥 Title: **{title}\n\n🔊 Duration:** {duration_min} Mins\n\n__[😒 Get Information Video](https://t.me/{BOT_USERNAME}?start=info_{videoid})__",
        ...
        return await message.reply_photo(
            photo=thumb,
            caption=f"❤️‍🔥 Title: **{title}\n\n🔊 Duration:** {duration_min} Mins\n\n**[😒 Get Information Video](https://t.me/{BOT_USERNAME}?start=info_{videoid})**",
            reply_markup=InlineKeyboardMarkup(buttons),
        )
