...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Flicks Music Bot Has Started Successfully!\n"
    )
    try:
        await app.send_message(
            LOG_GROUP_ID,
            "<b>[😁](https://t.me/skyzooff/10) Congrats!! Flicks Music Bot Has Started Successfully!</b>",
        )
    except Exception as e:
        print(
    ...
    try:
        await userbot.send_message(
            LOG_GROUP_ID,
            "<b>[😁](https://t.me/flicksrobotsupport/3743) Congrats!! Assistant Has Started Successfully!</b>",
        )
    except Exception as e:
        print(
        ...
        return
    try:
        await userbot.join_chat("SadRoomsInfo")
    except:
        pass
...
⚡️ Searched Powered By {BOT_NAME}t"""
